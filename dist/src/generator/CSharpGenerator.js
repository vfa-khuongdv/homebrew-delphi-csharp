...
class CSharpGenerator {
     ...
     */
    static convertIdentifier(identifier, context) {
        switch (context) {
            case 'class':
            case 'method':
            case 'property':
